...
\begin{proposicion}\label{pp:endomorfismo Weil}
	...
	\begin{enumerate}
		...
		\item $e_n(\sigma S, \sigma T) = \sigma(e_n(S, T))$ para todo automorfismo $\sigma$ de $overline{K}/K$. %(endomorfismo biyectivo) $\sigma$ de $\Kca$ tal que $\sigma$ sea la identidad en los coeficientes de $E$.
