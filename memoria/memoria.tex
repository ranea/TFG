...
% ## Especiales
\newtheorem{metodocuerda}[contador]{Versión geométrica del método de la cuerda y la tangente}
...
% Frontmatter
%*******************************************************
\include{PaginasInicialesFinales/Anteportada}
\include{PaginasInicialesFinales/Portada}
\cleardoublepage
\afterpage{\blankpage}
\cleardoublepage\include{PaginasInicialesFinales/Resumen}
\cleardoublepage\include{PaginasInicialesFinales/ResumenIngles}
%\afterpage{\blankpage}
\cleardoublepage\include{PaginasInicialesFinales/AutorizacionBiblioteca}
\cleardoublepage\include{PaginasInicialesFinales/AutorizacionTutor}
\cleardoublepage\include{PaginasInicialesFinales/Agradecimientos}
...
\cleardoublepage
\include{Capitulos/Capitulo0A}
%********************************************************************
% Other Stuff in the Back
%*******************************************************
\cleardoublepage\include{PaginasInicialesFinales/Bibliografia}
\afterpage{\blankpage}
% ********************************************************************
