...
$$
para algunas constafntes $a_2', a_4', a_6' \in K$. Finalmente, sustituyendo $x_1 = x + a_2'/3$ (podemos dividir por 3 ya que $\car(K) \neq 3$) resulta
$$
y_1^2 = x_1^3 + a x_1 + b
$$
...
El siguiente resultado será crucial en la demostración del teorema de Hasse~\ref{th:teorema de Hasse}. Denotaremos por  $\left\vert{C}\right\vert$ al número de elementos de un conjunto $C$.
