...
\begin{ejemplo}[curvas elípticas sobre $\mathbb{R}$]
	...
	\begin{figure}[h]
		\myfloatalign
		\subfloat[1]
		{\includegraphics[width=.45\linewidth]{gfx/grafo curva eliptica reales 1.pdf}} \quad
		\subfloat[2]
		{\includegraphics[width=.45\linewidth]{gfx/grafo curva eliptica reales 2.pdf}}
...
\begin{figure}[h]
  \myfloatalign
  \subfloat[][a]{\includegraphics[width=.45\linewidth]{gfx/"ejemplo adiccion".pdf}}
  \quad
  \subfloat[][b]{\includegraphics[width=.45\linewidth]{gfx/ejemplo duplicacion.pdf}}
