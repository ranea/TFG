...
En este apartado se tratarán las ecuaciones de Weierstrass, las operaciones de adicción y duplicación, los puntos proyectivos y los endomorfismos de curvas elípticas y los puntos de torsión.
...
% TODO: añadir ref
El principal objetivo de este apartado es probar la proposición~\ref{pp: cardinal del nucleo} que será utilizada en la demostración del teorema de Hasse~\ref{}. Para ello, es necesario utilizar algunos resultados técnicos, los cuales solo los enunciaremos (puede encontrar su demostración en ~\cite[sec. 2.9]{Washington:2008} ).
...
\begin{proposicion}
	...
	$$
\end{proposicion}
\begin{proof}\label{pp: cardinal del nucleo}
...
\begin{proof}[Demostración de la proposición~\ref{pp: cardinal del nucleo}]
